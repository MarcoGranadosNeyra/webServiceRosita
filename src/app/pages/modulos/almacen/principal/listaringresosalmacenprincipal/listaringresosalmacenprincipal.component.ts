...
@Component({
  selector: 'app-listaringresosalmacenprincipal',
  templateUrl: './listaringresosalmacenprincipal.component.html',
  styleUrls: ['./listaringresosalmacenprincipal.component.css']
})
export class ListaringresosalmacenprincipalComponent implements OnInit {
  ...
  if(this.formularioFechas.valid){
      this.almacenprincipalService.listarIngresosAlmacenPrincipal(this.formularioFechas.value)
      .subscribe(res => {
        this.dataArray = res;
