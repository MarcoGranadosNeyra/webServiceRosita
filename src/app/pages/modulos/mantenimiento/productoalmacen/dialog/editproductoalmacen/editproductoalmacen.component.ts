...
@Component({
  selector: 'app-editproductoalmacen',
  templateUrl: './editproductoalmacen.component.html',
  styleUrls: ['./editproductoalmacen.component.css']
})
export class EditproductoalmacenComponent  {
  ...
  constructor(
              ...
              public dialogRef: MatDialogRef<EditproductoalmacenComponent>, 
  ...
  actualizarProductoAlmacen() {
    console.log(this.formProductoAlmacen.value)
    if(this.formProductoAlmacen.valid){
      this.productoalmacenService.actualizarProductoAlmacen(this.formProductoAlmacen.value)
      .subscribe( res => {
        this.response=res;
